...
import type { BaseResponse_IPage_UserLearningRecord_ } from '../models/BaseResponse_IPage_UserLearningRecord_.ts';
import type { BaseResponse_List_UserLearningRecord_ } from '../models/BaseResponse_List_UserLearningRecord_.ts';
import type { BaseResponse_UserDailyGoal_ } from '../models/BaseResponse_UserDailyGoal_.ts';
import type { BaseResponse_UserLearningRecord_ } from '../models/BaseResponse_UserLearningRecord_.ts';
