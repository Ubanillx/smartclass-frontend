...
import type { BaseResponse_List_UserAiAvatarVO_ } from '../models/BaseResponse_List_UserAiAvatarVO_.ts';
import type { BaseResponse_long_ } from '../models/BaseResponse_long_.ts';
import type { BaseResponse_Page_UserAiAvatarVO_ } from '../models/BaseResponse_Page_UserAiAvatarVO_.ts';
import type { BaseResponse_UserAiAvatarVO_ } from '../models/BaseResponse_UserAiAvatarVO_.ts';
import type { DeleteRequest } from '../models/DeleteRequest.ts';
import type { UserAiAvatarAddRequest } from '../models/UserAiAvatarAddRequest.ts';
import type { UserAiAvatarUpdateRequest } from '../models/UserAiAvatarUpdateRequest.ts';
