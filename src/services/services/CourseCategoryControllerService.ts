...
import type { BaseResponse_CourseCategory_ } from '../models/BaseResponse_CourseCategory_.ts';
import type { BaseResponse_List_CourseCategory_ } from '../models/BaseResponse_List_CourseCategory_.ts';
import type { BaseResponse_long_ } from '../models/BaseResponse_long_.ts';
import type { CourseCategory } from '../models/CourseCategory.ts';
