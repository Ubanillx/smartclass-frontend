...
import type { BaseResponse_List_Map_string_object_ } from '../models/BaseResponse_List_Map_string_object_.ts';
...
import type { BaseResponse_Page_UserLearningRecordVO_ } from '../models/BaseResponse_Page_UserLearningRecordVO_.ts';
import type { BaseResponse_UserLearningRecordVO_ } from '../models/BaseResponse_UserLearningRecordVO_.ts';
import type { DeleteRequest_1 } from '../models/DeleteRequest_1.ts';
import type { UserLearningRecordAddRequest } from '../models/UserLearningRecordAddRequest.ts';
import type { UserLearningRecordQueryRequest } from '../models/UserLearningRecordQueryRequest.ts';
import type { UserLearningRecordUpdateRequest } from '../models/UserLearningRecordUpdateRequest.ts';
