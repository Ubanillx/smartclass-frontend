...
import type { BaseResponse_CourseSection_ } from '../models/BaseResponse_CourseSection_.ts';
import type { BaseResponse_int_ } from '../models/BaseResponse_int_.ts';
import type { BaseResponse_List_CourseSection_ } from '../models/BaseResponse_List_CourseSection_.ts';
import type { BaseResponse_long_ } from '../models/BaseResponse_long_.ts';
import type { BaseResponse_Page_CourseSection_ } from '../models/BaseResponse_Page_CourseSection_.ts';
import type { CourseSection } from '../models/CourseSection.ts';
