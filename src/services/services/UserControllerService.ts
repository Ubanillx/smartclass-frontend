...
import type { UserPhoneRegisterRequest } from '../models/UserPhoneRegisterRequest.ts';
...
export class UserControllerService {
  ...
  /**
   * userPhoneRegister
   * @param userPhoneRegisterRequest userPhoneRegisterRequest
   * @returns BaseResponse_long_ OK
   * @returns any Created
   * @throws ApiError
   */
  public static userPhoneRegisterUsingPost(
    userPhoneRegisterRequest: UserPhoneRegisterRequest,
  ): CancelablePromise<BaseResponse_long_ | any> {
    return __request(OpenAPI, {
      method: 'POST',
      url: '/api/user/register/phone',
      body: userPhoneRegisterRequest,
      errors: {
        401: `Unauthorized`,
        403: `Forbidden`,
        404: `Not Found`,
