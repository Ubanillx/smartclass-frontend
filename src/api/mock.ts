...
export const mockNotices: Notice[] = [
  {
    ...
    date: '2024-03-15',
    content:
      '我们很高兴地宣布，全新的 AI 口语助手功能现已上线！这个功能将帮助您提升口语水平，提供实时发音纠正和对话练习。欢迎体验并提供反馈。',
  },
  {
    id: 2,
    title: '系统维护通知',
    date: '2024-03-14',
    content:
      '为了给您提供更好的服务，系统将于本周日凌晨 2:00-4:00 进行例行维护，期间可能影响部分功能的使用。给您带来的不便敬请谅解。',
  },
  {
    id: 3,
    title: '课程更新预告',
    date: '2024-03-13',
    content:
      '下周将更新商务英语系列课程，包含电子邮件写作、商务谈判等实用主题。敬请期待！',
  },
  {
    id: 4,
    title: '用户体验调查',
    date: '2024-03-10',
    content:
      '为了不断改进我们的产品，我们诚邀您参与用户体验调查。完成调查的用户将获得7天VIP会员奖励。感谢您的宝贵意见！',
  },
  {
    id: 5,
    title: '新增学习资源',
    date: '2024-03-08',
    content:
      '我们新增了大量英语学习资源，包括各类考试真题、模拟试卷和学习材料。现在就去资源中心探索吧！',
  },
];
